...
public class Dringk_script : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
		...
		//	k++;
			...
			Debug.Log ("drink ");
			GameObject.Find ("green-water").transform.DOScaleX (0f, 3f).SetDelay (.2f);
			GameObject.Find ("green-water").transform.DOScaleY (0f, 3f).SetDelay (.2f);
...
//			}
	...
	void OnMouseUp(){
		Cursor.visible = true;
		GameObject.Find ("green-water").transform.DOPause ();
